...
import br.edu.ifsul.cstsi.projeto_cstsi_tads.api.participante.ParticipanteDTO;
...
public class JwtAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain, Authentication authentication) throws IOException {
        Participante p = (Participante) authentication.getPrincipal();
        String jwtToken = JwtUtil.createToken(p);
        String json = ParticipanteDTO.create(p, jwtToken).toJson();
